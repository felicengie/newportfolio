...
export function ContactInfo() {
  ...
  const copyEmail = async () => {
    await navigator.clipboard.writeText("chandrafelice12@gmail.com")
    setCopied(true)
    ...
    <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="font-medium">chandrafelice12@gmail.com</p>
              </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button asChild variant="outline" className="h-12 bg-transparent">
          <a
            href="https://www.linkedin.com/in/felice-chandra/"
            target="_blank"
        ...
        <Button asChild variant="outline" className="h-12 bg-transparent">
          <a
            href="https://github.com/felicengie"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2"
          >
